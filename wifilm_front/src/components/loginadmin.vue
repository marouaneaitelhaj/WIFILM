    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-8 mb-0 max-w-md space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" v-model="password" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm"
            ...
            <div class="flex items-center justify-between">
                ...
                <button @click="login" class="inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white">
                    Sign in
                </button>
            </div>
        </div>
