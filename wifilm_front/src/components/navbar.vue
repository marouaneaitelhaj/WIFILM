      ...
      <div class="flex h-16 items-center justify-between">
        <div class="">
          <a class="block text-white" href="/">
            ...
            <h1 class="text-3xl font-bold px-4 text-black rounded-md bg-yellow-400">
              WIFILM
            </h1>
          </a>
        </div>
        ...
        <div class="md:flex md:items-center md:gap-12">
          <nav aria-label="Site Nav" class="hidden md:block">
            <ul class="flex items-center gap-6 text-sm">
              ...
              <li>
                <RouterLink class="text-white transition hover:text-yellow-400" :to="{ name: 'discover' }">
                  Discover
                </RouterLink>
              </li>
          ...
          <div v-if="isAuth" class="flex items-center gap-4">
            <div class="sm:flex sm:gap-4">
              <a class="rounded-md bg-white px-5 py-2.5 text-sm font-medium text-black shadow" href="javascript:void(0)"
                v-on:click="logout()">
                Logout
              </a>
            </div>
            ...
            <div class="block md:hidden">
              <button @click="navbarbtn" class="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75">
