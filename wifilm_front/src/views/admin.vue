        ...
        <ul class="flex border-b border-gray-100">
            <li class="flex-1">
                <a href="javascript:void(0)" @click="opencrud('movies')" class="relative block p-4" to="admin/Movies">
                    <span class="absolute inset-x-0 -bottom-px h-1 w-full"
                        :class="{ 'bg-pink-600': component == 'movies' }"></span>

                    <div class="flex items-center justify-center gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0 text-gray-400" fill="none"
            ...
            <li class="flex-1">
                <a href="javascript:void(0)" @click="opencrud('users')" class="relative block p-4" to="">
                    <span class="absolute inset-x-0 -bottom-px h-1 w-full"
                        :class="{ 'bg-pink-600': component == 'users' }"></span>
            ...
            <li class="flex-1">
                <a href="javascript:void(0)" @click="opencrud('add')" class="relative block p-4" to="">
                    <span class="absolute inset-x-0 -bottom-px h-1 w-full" :class="{ 'bg-pink-600': component == 'add' }">
                    </span>
            ...
            <adminusers v-if="component == 'users'" />
